  ...
  return (
    <div className="flex flex-col justify-center items-center py-5 px-4 min-h-screen bg-white">
      ...
      <div className="desktop:max-w-[400px] tablet:max-w-[400px] mobile:w-full">
        ...
        <div className="mt-[32px] flex flex-col gap-[22px] text-green font-medium">
          <div>
        ...
        <div className="mt-[47px] flex flex-col gap-7">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-blackfont">{t("check1")}</span>
          </label>
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-blackfont">
              {t("check21")}{" "}
              <span onClick={() => setShowPrivacyPolicy(true)} className="text-red-500">{t("check22")}
              </span>
            </span>
          </label>
        </div>
        ...
        <div className="flex flex-col gap-4 mt-[45px]">
          <CustomButton onClick={handleSubmit} disabled={loading}>
            {loading ? t("processing") : t("button1")}
          </CustomButton>
          <div className="mt-3">
            <span>
              {" "}
              {t2("HaveAccount")}{" "}
              <a href="/login" className="  mt-6 font-bold">
                {t2("LoginAccount")}
              </a>
            </span>
          </div>
